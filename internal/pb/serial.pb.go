...
type Serial struct {
	...
	Points  []*SerialPoint `protobuf:"bytes,2,rep,name=points,proto3" json:"points,omitempty"`
}
...
func (x *Serial) GetPoints() []*SerialPoint {
	if x != nil {
		return x.Points
	}
	return nil
...
var file_serial_proto_rawDesc = []byte{
	...
	0x4b, 0x0a, 0x06, 0x53, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x75, 0x62,
	0x6a, 0x65, 0x63, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x73, 0x75, 0x62, 0x6a,
	0x65, 0x63, 0x74, 0x12, 0x27, 0x0a, 0x06, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x73, 0x18, 0x02, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x70, 0x62, 0x2e, 0x53, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x50,
	0x6f, 0x69, 0x6e, 0x74, 0x52, 0x06, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x73, 0x42, 0x0d, 0x5a, 0x0b,
...
var file_serial_proto_goTypes = []interface{}{
	...
	(*SerialPoint)(nil), // 1: pb.SerialPoint
}
var file_serial_proto_depIdxs = []int32{
	1, // 0: pb.Serial.points:type_name -> pb.SerialPoint
