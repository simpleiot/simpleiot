...
var $author$project$Global$SignedOut = {$: 'SignedOut'};
...
var $author$project$Global$init = F2(
	function (_v0, _v1) {
		return _Utils_Tuple3(
			$author$project$Global$SignedOut,
			$elm$core$Platform$Cmd$none,
			$author$project$Ports$log('Hello!'));
	});
var $author$project$Generated$Pages$HomeModel = function (a) {
	return {$: 'HomeModel', a: a};
};
var $author$project$Generated$Pages$HomeMsg = function (a) {
	return {$: 'HomeMsg', a: a};
};
...
var $author$project$Pages$Home$view = $mdgriffith$elm_ui$Element$text('hi there');
var $author$project$Pages$Home$page = $ryannhg$elm_spa$Spa$Page$static(
	{
		title: $elm$core$Basics$always('Home'),
		view: $elm$core$Basics$always($author$project$Pages$Home$view)
	});
...
var $author$project$Generated$Route$Home = function (a) {
	return {$: 'Home', a: a};
};
...
var $author$project$Generated$Routes$routes = {
	home: $author$project$Generated$Route$Home(
		{}),
	notFound: $author$project$Generated$Route$NotFound(
		{}),
	signIn: $author$project$Generated$Route$SignIn(
		{}),
...
var $author$project$Pages$SignIn$init = function (flags) {
	return _Utils_Tuple3(
		{email: '', password: ''},
		$elm$core$Platform$Cmd$none,
		$elm$core$Platform$Cmd$none);
		...
		if (msg.$ === 'UpdatedField') {
			...
			return _Utils_Tuple3(
				...
				$ryannhg$elm_spa$Spa$Page$send(
					$author$project$Global$SignIn(model)));
		}
	});
var $author$project$Pages$SignIn$ClickedSignIn = {$: 'ClickedSignIn'};
var $author$project$Pages$SignIn$Email = {$: 'Email'};
var $author$project$Pages$SignIn$EmailInput = {$: 'EmailInput'};
var $author$project$Pages$SignIn$Password = {$: 'Password'};
var $author$project$Pages$SignIn$PasswordInput = {$: 'PasswordInput'};
var $author$project$Pages$SignIn$UpdatedField = F2(
	function (a, b) {
		return {$: 'UpdatedField', a: a, b: b};
	});
...
var $author$project$Utils$Styles$colors = {
	coral: A3($mdgriffith$elm_ui$Element$rgb255, 204, 75, 75),
	jet: A3($mdgriffith$elm_ui$Element$rgb255, 40, 40, 40),
...
var $author$project$Utils$Styles$transition = function (_v0) {
	var property = _v0.property;
	var duration = _v0.duration;
	return $mdgriffith$elm_ui$Element$htmlAttribute(
		A2(
			$elm$html$Html$Attributes$style,
			'transition',
			property + (' ' + ($elm$core$String$fromInt(duration) + 'ms ease-in-out'))));
};
...
var $author$project$Utils$Styles$button = _List_fromArray(
	[
		A2($mdgriffith$elm_ui$Element$paddingXY, 16, 8),
		$mdgriffith$elm_ui$Element$Font$size(14),
		$mdgriffith$elm_ui$Element$Border$color($author$project$Utils$Styles$colors.coral),
		$mdgriffith$elm_ui$Element$Font$color($author$project$Utils$Styles$colors.coral),
		$mdgriffith$elm_ui$Element$Background$color($author$project$Utils$Styles$colors.white),
		$mdgriffith$elm_ui$Element$Border$width(2),
		$mdgriffith$elm_ui$Element$Border$rounded(4),
		$mdgriffith$elm_ui$Element$pointer,
		$author$project$Utils$Styles$transition(
		{duration: 150, property: 'all'}),
		$mdgriffith$elm_ui$Element$mouseOver(
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Font$color($author$project$Utils$Styles$colors.white),
				$mdgriffith$elm_ui$Element$Background$color($author$project$Utils$Styles$colors.coral)
			]))
	]);
...
var $author$project$Pages$SignIn$toHtml = A2(
	...
	_List_Nil);
var $author$project$Pages$SignIn$form = F3(
	function (config, attrs, children) {
		return $mdgriffith$elm_ui$Element$html(
			A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onSubmit(config.onSubmit)
					]),
				_List_fromArray(
					[
						$author$project$Pages$SignIn$toHtml(
						A2($mdgriffith$elm_ui$Element$column, attrs, children))
					])));
	});
...
var $author$project$Pages$SignIn$viewField = function (config) {
	var styles = {
		field: _List_fromArray(
			[
	...
	var _v0 = config.inputType;
	if (_v0.$ === 'EmailInput') {
		return A2(
			$mdgriffith$elm_ui$Element$Input$email,
			styles.field,
			{label: label, onChange: config.onChange, placeholder: $elm$core$Maybe$Nothing, text: config.value});
	} else {
		return A2(
			$mdgriffith$elm_ui$Element$Input$currentPassword,
			styles.field,
			{label: label, onChange: config.onChange, placeholder: $elm$core$Maybe$Nothing, show: false, text: config.value});
	}
};
var $author$project$Pages$SignIn$view = function (model) {
	return A2(
		...
		A3(
			$author$project$Pages$SignIn$form,
			{onSubmit: $author$project$Pages$SignIn$ClickedSignIn},
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Pages$SignIn$viewField(
							{
								inputType: $author$project$Pages$SignIn$EmailInput,
								label: 'Email',
								onChange: $author$project$Pages$SignIn$UpdatedField($author$project$Pages$SignIn$Email),
								value: model.email
							}),
							$author$project$Pages$SignIn$viewField(
							{
								inputType: $author$project$Pages$SignIn$PasswordInput,
								label: 'Password',
								onChange: $author$project$Pages$SignIn$UpdatedField($author$project$Pages$SignIn$Password),
					...
					$elm$core$String$isEmpty(model.email) ? A2(
						...
						{
							label: $mdgriffith$elm_ui$Element$text('Sign In'),
							onPress: $elm$core$Maybe$Just($author$project$Pages$SignIn$ClickedSignIn)
						}))
				])));
};
var $author$project$Pages$SignIn$page = $ryannhg$elm_spa$Spa$Page$component(
	{
		init: $elm$core$Basics$always($author$project$Pages$SignIn$init),
		subscriptions: $elm$core$Basics$always($author$project$Pages$SignIn$subscriptions),
		title: $elm$core$Basics$always('sign in | elm-spa'),
		update: $elm$core$Basics$always($author$project$Pages$SignIn$update),
		view: $elm$core$Basics$always($author$project$Pages$SignIn$view)
	});
		...
		[
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$text('Simple IoT')),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[
...
var $author$project$Generated$Pages$recipes = {
	home: $author$project$Utils$Spa$recipe(
		{page: $author$project$Pages$Home$page, toModel: $author$project$Generated$Pages$HomeModel, toMsg: $author$project$Generated$Pages$HomeMsg}),
	...
	signIn: $author$project$Utils$Spa$recipe(
		{page: $author$project$Pages$SignIn$page, toModel: $author$project$Generated$Pages$SignInModel, toMsg: $author$project$Generated$Pages$SignInMsg}),
...
var $author$project$Generated$Pages$bundle = function (bigModel) {
	switch (bigModel.$) {
		case 'HomeModel':
			...
			return $author$project$Generated$Pages$recipes.home.bundle(model);
		case 'NotFoundModel':
			var model = bigModel.a;
			return $author$project$Generated$Pages$recipes.notFound.bundle(model);
		case 'SignInModel':
			var model = bigModel.a;
			return $author$project$Generated$Pages$recipes.signIn.bundle(model);
		default:
			var model = bigModel.a;
...
var $author$project$Generated$Pages$init = function (route_) {
	switch (route_.$) {
		case 'Home':
			var params = route_.a;
			return $author$project$Generated$Pages$recipes.home.init(params);
		case 'NotFound':
			var params = route_.a;
			return $author$project$Generated$Pages$recipes.notFound.init(params);
		case 'SignIn':
			var params = route_.a;
			return $author$project$Generated$Pages$recipes.signIn.init(params);
		default:
			var params = route_.a;
			...
			switch (_v0.a.$) {
				case 'HomeMsg':
					if (_v0.b.$ === 'HomeModel') {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Generated$Pages$recipes.home.update, msg, model);
					} else {
						break _v0$4;
					}
				case 'NotFoundMsg':
				...
				case 'SignInMsg':
					if (_v0.b.$ === 'SignInModel') {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Generated$Pages$recipes.signIn.update, msg, model);
					} else {
						break _v0$4;
					}
				default:
...
var $author$project$Utils$Styles$fonts = {
	sans: _List_fromArray(
		[
			$mdgriffith$elm_ui$Element$Font$external(
			{name: 'IBM Plex Sans', url: 'https://fonts.googleapis.com/css?family=IBM+Plex+Sans:400,400i,600,600i&display=swap'}),
...
var $author$project$Global$SignOut = {$: 'SignOut'};
...
var $author$project$Components$Button$view = function (config) {
	return A2(
		$mdgriffith$elm_ui$Element$Input$button,
		A2(
			$elm$core$List$cons,
			_Utils_eq(config.onPress, $elm$core$Maybe$Nothing) ? $mdgriffith$elm_ui$Element$alpha(0.6) : $mdgriffith$elm_ui$Element$alpha(1),
			$author$project$Utils$Styles$button),
		config);
};
var $author$project$Layout$viewButtonLink = function (_v0) {
	var label = _v0.a;
	var url = _v0.b;
	return A2(
		$mdgriffith$elm_ui$Element$link,
...
var $author$project$Utils$Styles$link = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$Font$underline,
		$mdgriffith$elm_ui$Element$Font$color($author$project$Utils$Styles$colors.coral),
		$author$project$Utils$Styles$transition(
		{duration: 150, property: 'opacity'}),
		$mdgriffith$elm_ui$Element$mouseOver(
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$alpha(0.6)
...
var $author$project$Layout$viewLink = function (_v0) {
	var label = _v0.a;
	var url = _v0.b;
	return A2(
		$mdgriffith$elm_ui$Element$link,
		$author$project$Utils$Styles$link,
		{
			label: $mdgriffith$elm_ui$Element$text(label),
			url: url
		});
};
var $author$project$Layout$viewNavbar = function (model) {
	return A2(
			...
			[
				...
				A2(
					...
					A2(
						...
						{
							label: $mdgriffith$elm_ui$Element$text('SIOT'),
							url: '/'
						}),
					A2(
						$elm$core$List$map,
				...
				function () {
					if (model.$ === 'SignedIn') {
						...
						return $author$project$Components$Button$view(
							{
								label: $mdgriffith$elm_ui$Element$text('sign out ' + sess.cred.email),
								onPress: $elm$core$Maybe$Just($author$project$Global$SignOut)
							});
					} else {
						return $author$project$Layout$viewButtonLink(
							_Utils_Tuple2('sign in', '/sign-in'));
					}
				}())
			]));
};
var $author$project$Layout$view = function (_v0) {
	...
	var fromGlobalMsg = _v0.fromGlobalMsg;
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Font$size(16),
				$mdgriffith$elm_ui$Element$Font$color($author$project$Utils$Styles$colors.jet),
				$mdgriffith$elm_ui$Element$Font$family($author$project$Utils$Styles$fonts.sans),
		...
		_List_fromArray(
			[
				...
				fromGlobalMsg,
				$author$project$Layout$viewNavbar(global)),
				page
			]));
};
...
var $author$project$Generated$Routes$parsers = _List_fromArray(
	[
		...
		$author$project$Generated$Routes$routes.home,
		...
		A2(
		$elm$url$Url$Parser$map,
		$author$project$Generated$Routes$routes.signIn,
...
var $author$project$Transitions$transitions = {
	...
	page: $ryannhg$elm_spa$Spa$Transition$fadeElmUi(100),
	pages: _List_Nil
};
var $author$project$Global$SignedIn = function (a) {
	return {$: 'SignedIn', a: a};
};
var $author$project$Global$AuthResponse = F2(
	function (a, b) {
		return {$: 'AuthResponse', a: a, b: b};
	});
...
var $author$project$Global$login = function (cred) {
	return $elm$http$Http$post(
		{
			body: $elm$http$Http$multipartBody(
				_List_fromArray(
					[
						A2($elm$http$Http$stringPart, 'email', cred.email),
						A2($elm$http$Http$stringPart, 'password', cred.password)
					])),
			expect: $elm$http$Http$expectString(
				function (resp) {
					return A2($author$project$Global$AuthResponse, cred, resp);
				}),
	...
	function (commands, msg, model) {
		switch (msg.$) {
			case 'SignIn':
				...
				return _Utils_Tuple3(
					$author$project$Global$SignedOut,
					$author$project$Global$login(cred),
					commands.navigate($author$project$Generated$Routes$routes.top));
			case 'SignOut':
				return _Utils_Tuple3($author$project$Global$SignedOut, $elm$core$Platform$Cmd$none, $elm$core$Platform$Cmd$none);
			default:
				var cred = msg.a;
				var resp = msg.b;
				return _Utils_Tuple3(
					function () {
						if (resp.$ === 'Ok') {
							var token = resp.a;
							return $author$project$Global$SignedIn(
								{authToken: token, cred: cred});
						} else {
							var err = resp.a;
							return $author$project$Global$SignedOut;
						}
					}(),
					$elm$core$Platform$Cmd$none,
					$elm$core$Platform$Cmd$none);
